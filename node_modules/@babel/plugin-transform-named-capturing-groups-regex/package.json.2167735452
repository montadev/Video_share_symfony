{
  "_from": "@babel/plugin-transform-named-capturing-groups-regex@^7.4.5",
  ...
  "_requested": {
    "type": "range",
    "registry": true,
    "raw": "@babel/plugin-transform-named-capturing-groups-regex@^7.4.5",
  ...
  "_spec": "@babel/plugin-transform-named-capturing-groups-regex@^7.4.5",
